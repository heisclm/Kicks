...
export default function SettingsScreen() {
  ...
  const { currency, language, location, orderUpdates, setNotificationPreference } = usePreferencesStore();
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <SettingToggle 
              ...
              value={orderUpdates} 
              onValueChange={(val: boolean) => setNotificationPreference('orderUpdates', val)} 
            />
